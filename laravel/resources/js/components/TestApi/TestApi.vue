<template>
    <div>
        <div>
            ...
            <div v-show="showPost">
                <div>
                    <span>이름</span> <input type="text" v-model="nameText" />
                </div>
                <div>
                    <span>팀 명</span>
                    <input type="text" v-model="teamNameText" />
                </div>
                <div>
                    <span>핸드폰 번호(선택)</span>
            ...
            <table>
                <tr>
                    ...
                    <th>핸드폰 번호</th>
                    <th>
                        수정모드<input type="checkbox" v-model="isChecked" />
                    </th>
                </tr>
                <tr v-for="(el, idx) in membersData.data" :key="idx">
